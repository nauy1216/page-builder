    ...
    return (
      <el-form label-position="right" label-width="100px">
        ...
        <el-form-item label="页面宽度(px)">
          <el-input-number vModel={this.pageConfig.width} precision={2} step={1}></el-input-number>
        </el-form-item>
        <el-form-item label="页面高度(px)">
          <el-input-number vModel={this.pageConfig.height} precision={2} step={1}></el-input-number>
        </el-form-item>
        <el-form-item label="页面背景">
          <el-input vModel={this.pageConfig.background}></el-input>
        </el-form-item>
        <el-form-item label="网格宽度(px)">
          <el-input-number vModel={this.editorConfig.gridX} precision={0} step={1}></el-input-number>
        </el-form-item>
        <el-form-item label="网格高度(px)">
          <el-input-number vModel={this.editorConfig.gridY} precision={0} step={1}></el-input-number>
        </el-form-item>
        <el-form-item label="缩放">
          <el-input-number vModel={this.editorConfig.zoom} min={0.1} max={10} precision={1} step={0.1}></el-input-number>
        </el-form-item>
